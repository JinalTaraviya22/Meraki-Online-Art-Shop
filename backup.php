...
<body class="bg-dark">
                ...
                <table>
                    ...
                    while ($r = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-dark" onclick="showUser (<?php echo $r['U_Id']; ?>)"><i
                                        class="fa fa-eye"></i></button>
                                <input type="hidden" id="showUsr_<?php echo $r['U_Id']; ?>"
    ...
    <script type="text/javascript">
        ...
        function showUser(id) {
            var showUsr = document.getElementById('showUsr_' + id).value;
            document.getElementById('user_profile_' + id).style.display = 'block';
        }
        function asd(a) {
            if (a == 1) {
                $('#update').show();
